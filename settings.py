...
SESSION_CONFIGS = [
    dict(
        ...
        # Gibt den Faktor an, der zur Berechnung der Rückzahlungs-Boni verwendet werden soll
        # Beispiel: 0.2 => Spieler erhält einen Rückzahlungs-Bonus von 20% auf die Spenden, die im Bonus-Zeitraum abgegeben wurden
        ...
        # Gibt den Faktor an, der zur Berechnung der Early-Bird-Boni verwendet werden soll
        # Beispiel: 0.1 => Early Bird Bonus beträgt 10% der Spenden, die im Bonus-Zeitraum abgegeben wurden
        ...
        # Kosten, die beim Ausstieg aus einem Projekt anfallen (können auf 0 gesetzt werden)
        Backout_Fees=10,

        # Gibt an, ob die Anzahl der Spieler, die ein Projekt unterstützen, angezeigt werden soll
